...
export default function ProfilePage({ params }: ProfilePageProps) {
  ...
  return (
    <AppShell title={`${profileUser.displayName} (@${profileUser.username})`}>
      <div className="max-w-[935px] mx-auto py-4 sm:py-8 px-4 sm:px-8 space-y-8 select-none">
        {/* Profile Header */}
        <header className="flex flex-col sm:flex-row items-center sm:items-start gap-8 sm:gap-16">
          ...
          <div className="relative group">
            ...
            {isSelf && (
              <button
                ...
                className="absolute bottom-1 right-1 p-2 bg-[#0095f6] hover:bg-[#1877f2] text-white rounded-full ring-4 ring-[var(--bg-primary)] shadow-lg transition-transform hover:scale-110 cursor-pointer z-10"
                title="Add to story"
          ...
          <div className="flex-1 space-y-4 w-full">
              ...
              {isSelf ? (
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-4 py-1.5 rounded-lg bg-neutral-100 dark:bg-neutral-800 hover:bg-neutral-200 dark:hover:bg-neutral-700 text-xs font-semibold text-[var(--text-primary)] transition-colors cursor-pointer"
                  >
                    Edit profile
                  </button>
                  <button
                    onClick={() => setIsCreateModalOpen(true)}
                    className="px-4 py-1.5 rounded-lg bg-[#0095f6] hover:bg-[#1877f2] text-white text-xs font-semibold transition-colors cursor-pointer flex items-center gap-1.5 shadow-sm"
                  >
                  ...
                  <Link
                    href="/settings"
                    className="p-2 rounded-lg bg-neutral-100 dark:bg-neutral-800 hover:bg-neutral-200 dark:hover:bg-neutral-700 text-[var(--text-primary)] transition-colors"
                    aria-label="Settings"
                  >
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className={`px-5 py-1.5 rounded-lg text-xs font-semibold transition-colors cursor-pointer ${
                      followingThisUser
                        ? 'bg-neutral-100 dark:bg-neutral-800 text-[var(--text-primary)] hover:bg-neutral-200'
            ...
            <div className="flex items-center gap-8 text-sm">
              <div>
                <span className="font-semibold text-[var(--text-primary)]">{profileUser.postsCount}</span>{' '}
              ...
              >
                <span className="font-semibold text-[var(--text-primary)]">{formatNumber(profileUser.followersCount)}</span>{' '}
              ...
              <button
                ...
                className="cursor-pointer hover:opacity-80"
              >
                <span className="font-semibold text-[var(--text-primary)]">{formatNumber(profileUser.followingCount)}</span>{' '}
            ...
            <div className="text-xs text-[var(--text-primary)] space-y-1">
              ...
              {profileUser.website && (
                <a
                  ...
                  className="flex items-center gap-1 font-semibold text-[#00376b] dark:text-[#e0f1ff] hover:underline"
                >
