    ...
    <div className="relative min-h-screen bg-black text-white flex flex-col items-center justify-center p-4 select-none overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[420px] space-y-4">
        ...
        <div className="bg-[var(--glass-card-bg)] backdrop-blur-3xl border border-[var(--glass-border)] shadow-[var(--glass-shadow-lg)] p-7 sm:p-8 space-y-5 rounded-3xl transition-all">
          ...
          {/* Premium Interactive Google Sign-In Section */}
          <div className="w-full space-y-3 pt-1">
            {/* Quick 1-Tap Saved Account Card (Mujeeb Rahman) */}
            <div
              onClick={() => handleSelectGoogleAccount('mujee00012@gmail.com', 'Mujeeb Rahman', '/images/avatar-mujeeb.png')}
              className="relative group p-3 rounded-2xl bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-pink-500/10 hover:from-blue-500/20 hover:via-purple-500/20 hover:to-pink-500/20 border border-blue-500/30 hover:border-blue-400/60 shadow-lg shadow-blue-500/10 transition-all cursor-pointer backdrop-blur-md active:scale-98"
            >
              <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-3 min-w-0">
                  <div className="relative w-10 h-10 rounded-full overflow-hidden shrink-0 ring-2 ring-blue-400/50 shadow-md">
                    <Image
                      src="/images/avatar-mujeeb.png"
                      alt="Mujeeb Rahman"
                      fill
                      className="object-cover"
                      unoptimized
                    />
                    <div className="absolute bottom-0 right-0 w-2.5 h-2.5 rounded-full bg-emerald-400 ring-2 ring-black" />
                  </div>
                  <div className="min-w-0">
                    <div className="flex items-center gap-1.5">
                      <p className="text-xs font-bold text-white truncate">Mujeeb Rahman</p>
                      <span className="px-1.5 py-0.2 rounded-md bg-blue-500/20 text-blue-300 text-[9px] font-bold">
                        Google
                      </span>
                    </div>
                    <p className="text-[11px] text-neutral-400 truncate">mujee00012@gmail.com</p>
                  </div>
                </div>

                <div className="shrink-0 flex items-center gap-1 text-xs font-bold text-blue-400 group-hover:text-blue-300 group-hover:translate-x-0.5 transition-all">
                  <span>Continue</span>
                  <ArrowRight className="w-3.5 h-3.5" />
                </div>
              </div>
            ...
            {/* Choose Other Google Account / Custom Login */}
            <button
              type="button"
              onClick={handleOpenGoogleChooser}
              className="w-full py-2.5 px-4 rounded-2xl bg-white hover:bg-neutral-100 text-neutral-900 text-xs font-bold flex items-center justify-center gap-3 transition-all active:scale-98 shadow-md hover:shadow-xl hover:shadow-blue-500/10 cursor-pointer"
            >
